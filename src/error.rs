...
/// expected ...
pub fn e0001(lines: std::str::Lines, token: &Token, expect: TokenKind) -> ! {
...
/// expected type
pub fn e0002(lines: std::str::Lines, token: &Token) -> ! {
...
/// expected identifier
pub fn e0003(lines: std::str::Lines, token: &Token) -> ! {
...
/// expected item
pub fn e0004(lines: std::str::Lines, token: &Token) -> ! {
...
pub fn e0005(lines: std::str::Lines, token: &Token, ident: &str) -> ! {
...
pub fn e0006(lines: std::str::Lines, token: &Token) -> ! {
...
pub fn e0007(lines: std::str::Lines, token: &Token, ident: &str) -> ! {
...
/// expected `,`, or `}`
pub fn e0008(lines: std::str::Lines, token: &Token) -> ! {
...
/// expected one of `!`, `(`, `)`, `+`, `,`, `::`, or `<`
pub fn e0009(lines: std::str::Lines, token: &Token) -> ! {
...
pub fn e0010(lines: std::str::Lines, token: &Token) -> ! {
...
pub fn e0011(lines: std::str::Lines, token: &Token) -> ! {
    eprintln!("cannot `break` outside of a loop");
    eprint_nearby(lines, token).ok();
    panic!();
}

fn eprint_nearby(mut lines: std::str::Lines, token: &Token) -> Result<(), ()> {
    let line = token.line;
